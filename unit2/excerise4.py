...
stats = weeklyPlayerStats(2024, "RB", week= 1) 
print (stats)

#plot_player_stat(stats, stat="passing_tds", top_n=20, title="QB Passing touchdowns (2024)", save_path="qb_passing_tds_2024.png"  )


#plot_weekly_player_stats(2024)
# 2) One-liner wrapper:
...
"i used the most passing touchdowns of 2024 to answee the qustion"
# 2. Find the player with the most touchdowns in 2024?
"Derick Henry had the most total touchdowns at 21 TD's"
# 3. find the player with the highest total passing yards in 2024.
"J.Goff had the highest total passing yards in 2024"
# 4. which player had the highest rushing yards in week 1 and in week 17?
"for week in its J.Mason and for week 17 it's S. Barkley"