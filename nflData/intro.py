...
# path = os.path.abspath("nfldata/nfl_2024.csv")

# # records = pd.read_csv(path)
# # print(records.head())
# # print(records.colums)

# teams = nfl.import_team_desc()
# # team_stats = nfl.import_season1_data([2024])


# print(teams)
# #print(team_stats)

# bestRecord = team_stats.sort_values(by = "wins", asending= False )
